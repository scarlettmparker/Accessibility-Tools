...
const MagnifyingGlass = ({ zoom = 2, glassStyle = {
    ...
    const magnify = (0, react_1.useCallback)((glass, zoom) => {
        ...
        if (targetContainer) {
             ...
             */
            (0, html2canvas_1.default)(targetContainer).then((canvas) => {
                if (targetContainer) {
    ...
    return (react_1.default.createElement("div", { ref: glassRef, id: "magnifying-glass", style: Object.assign(Object.assign({}, glassStyle), { position: "absolute", pointerEvents: "none" }) }));
};
